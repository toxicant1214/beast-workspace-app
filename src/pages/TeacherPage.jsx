...
import TeacherPermissionModal
  from "../components/TeacherPermissionModal";
...
function TeacherPage() {
  ...
  const editingTeacherHasAccount =
    Boolean(
  ...
  async function handleSendPasswordReset(
    ...
    try {
      ...
      await sendTeacherPasswordReset(
        teacher.email
      );
  ...
  return (
    <main className="teacher-page">
      <section className="teacher-page__header">
        <div>
          <p className="teacher-page__eyebrow">
            Teacher Management
          </p>
