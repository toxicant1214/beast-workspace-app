...
const CAMP_SECTIONS = [
  { key: "overview", title: "總覽", description: "查看本期營隊設定與目前進度。" },
  { key: "students", title: "學生與每日報名", description: "管理本期學生與每天的參加內容。" },
  { key: "classes", title: "營隊編班", description: "建立編班區間並安排各班學生。" },
  { key: "staff", title: "工作人員", description: "建立這一期自己的工作人員與請假資料。" },
  { key: "schedule", title: "人員排班", description: "安排主帶、助教、特殊任務與每日班別。" },
  { key: "cleaning", title: "清潔與工作安排", description: "設定本期清潔項目與每日輪值。" },
  ...
  return (
    <div className="campPage">
      ...
      <section className="campDetailIntro">
        ...
        <p>
          此處建立的學生、編班、工作人員、排班與清潔資料只屬於這一期營隊。
        </p>
      </section>

      <section className="campSectionGrid">
        {CAMP_SECTIONS.map((section) => {
          const isReady = section.key === "students";
