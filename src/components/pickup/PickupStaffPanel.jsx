...
function TeacherTags({
  ...
  return (
    <div
      className="pickupStaffTagEditor"
      style={{ minWidth: 0, width: "100%" }}
    >
      <div
        className="pickupStaffTags"
        style={{
          display: "flex",
          flexWrap: "wrap",
          alignItems: "center",
...
function PickupStaffPanel() {
  ...
  function renderPdfWeekdayPage(weekday) {
